...
class Crawl:
    ...
    def get_symbols_data():
        market_rows = Crawl.get_csv_rows(Crawl.market, 'MarketWatchInit.csv')
        symbols_reformatted = Crawl.ready_symbols(market_rows)
...
class SaveToDB:
    ...
    def save_symbols():
        ...
        '''
            ...
            col23
        '''
        coll_symbols = SaveToDB.coll_symbols
    ...
    def save_transactions():
        ...
        collist = SaveToDB.collist
        coll_transactions = SaveToDB.coll_transactions
        # Transactions
        for i in symbols:
            inst = Crawl.inst_calendar + i
    ...
    def save_symbols_history(days):
        coll_transactions = SaveToDB.coll_transactions
        coll_bestlimitdata = SaveToDB.coll_bestlimitdata
        coll_closingpricedata = SaveToDB.coll_closingpricedata
        coll_intradaypricedata = SaveToDB.coll_intradaypricedata
        coll_intratradedata = SaveToDB.coll_intratradedata
        symbols = SaveToDB.symbols
    ...
    # save data
    def save_data(days):
        SaveToDB.save_symbols()
        SaveToDB.save_transactions()
        SaveToDB.save_symbols_history(days)
